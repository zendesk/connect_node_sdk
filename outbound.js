;(function(exports){
    ...
    function headers(apiKey) {
        return {
            ...
            'X-Outbound-Client': 'javascript',
            'X-Outbound-Client-Version': VERSION,
            'X-Outbound-Key': apiKey
        };
    }
    ...
    Outbound.prototype.identify = function(userId, info, attributes) {
        ...
        if (typeofUserId != "number" && typeofUserId != "string") {
            ...
            post('/identify', requestData, headers(this.apiKey), deferred);
        }
    ...
    Outbound.prototype.track = function(userId, event, properties, userInfo, userAttributes) {
        ...
        if (typeofUserId != "number" && typeofUserId != "string") {
            ...
            requestData = {"user_id": userId, "properties": properties, "event": event}
